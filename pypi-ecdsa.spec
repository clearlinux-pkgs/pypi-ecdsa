...
Source0  : https://files.pythonhosted.org/packages/5e/d0/ec8ac1de7accdcf18cfe468653ef00afd2f609faf67c423efbd02491051b/ecdsa-0.19.0.tar.gz
...
%prep
%setup -q -n ecdsa-0.19.0
cd %{_builddir}/ecdsa-0.19.0
pushd ..
cp -a ecdsa-0.19.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712610901
